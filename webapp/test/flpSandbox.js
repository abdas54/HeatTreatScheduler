		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Heat Treat Scheduler",
									"targetURL": "#eymegroothtsapp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"eymegroothtsapp2-display": {
								"semanticObject": "eymegroothtsapp2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ey.meg.root.htsapp2",
									"url": sap.ui.require.toUrl("ey/meg/root/htsapp2")
								}
							}
						}
					}
